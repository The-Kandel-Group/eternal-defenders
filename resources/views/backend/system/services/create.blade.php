...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            <h5 class="card-header">{{ __('Create Service') }}</h5>

            <form class="card-body" action="{{ route('services.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                        ...
                        <select class="form-control @error('service_category_id') is-invalid @enderror" required
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}"
                                        @if(old('service_category_id') == $category->id) selected @endif>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sub_title" id="sub_title" value="{{ old('sub_title') }}" required
